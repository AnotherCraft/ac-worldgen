...
QSharedPointer <WGA_DataRecord_CPU> WGA_DataCacheInstance_CPU::get(const WGA_DataCacheInstance_CPU::Key &key) {
...
void WGA_DataCacheInstance_CPU::insert(const WGA_DataCacheInstance_CPU::Key &key, const QSharedPointer <WGA_DataRecord_CPU> &value, size_t memorySize) {
